...
Retained or corrected through beta version 57: same-origin `/ics` Worker routing; skip link; keyboard tabs and associated panels; one h1 per view; corrected tablist ownership; keyboard-accessible file inputs; editable monthly journey tables and isolated payroll previews; table captions and scopes; contextual repeated-control names; persistent Setup errors; focus/dialog behaviour; weekly shift grouping and deletion Undo; expanded display and accessibility preferences; responsive shift controls; reduced motion; and forced-colour support. General typography, sizing and unrelated visible workflow revisions from version 53 were rolled back as requested and must not be treated as completed audit corrections.
