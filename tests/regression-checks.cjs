...
assert.match(app, /const APP_SHELL_VERSION='24'/);
...
assert.match(html, /id="openDashboard"[^>]+Telemetry dashboard - coming in the next beta update/);
assert.match(app05, /openDashboard.*private telemetry dashboard is coming in the next beta update/);
