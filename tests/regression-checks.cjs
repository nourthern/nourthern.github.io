...
assert.match(app, /const APP_SHELL_VERSION='56'/);
...
assert.match(styles, /\.brand-block p\{display:inline-block[^}]+background:var\(--card-white\)/);
...
assert.match(sw, /pier-travel-expense-manager-v56/);
...
assert.match(app05, /const APP_VERSION='56'/);
