...
assert.match(app, /const APP_SHELL_VERSION='26'/);
...
assert.match(styles, /\.brand-block p\{[^}]*opacity:1;text-shadow:none/);
assert.match(styles, /@media\(min-width:901px\)\{\.topbar\{justify-content:flex-start/);
assert.match(sw, /pier-travel-expense-manager-v38/);
...
assert.match(app05, /const APP_VERSION='26'/);
