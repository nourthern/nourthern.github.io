...
assert.match(app, /const APP_SHELL_VERSION='23'/);
...
assert.match(styles, /\.tab\{background:var\(--sunlit-gold\);color:var\(--cool-dusk\)\}/);
assert.match(styles, /\.tab\.active\{background:var\(--sunset-amber\);color:var\(--cool-dusk\)\}/);
assert.match(styles, /\.tab:hover,\.tab:focus-visible\{background:var\(--sunset-amber\);color:var\(--cool-dusk\)\}/);
...
assert.match(styles, /\.button-link\.primary\[id\$="Continue"\]\{background:var\(--sunset-amber\);color:var\(--cool-dusk\)\}/);
assert.match(styles, /\.button-link\.primary\[id\$="Continue"\]:hover,[^\n]+background:var\(--sunlit-gold\);color:var\(--cool-dusk\)/);
assert.match(styles, /\.month-chip\{border-color:var\(--shore-sand\);background:var\(--shore-sand\);color:var\(--cool-dusk\)\}/);
assert.match(styles, /\.month-chip:has\(input:checked\)\{border-color:var\(--sunlit-gold\);background:var\(--sunlit-gold\);color:var\(--cool-dusk\)\}/);
...
assert.match(styles, /\.brand-block p\{margin:0;text-align:left/);
assert.match(sw, /pier-travel-expense-manager-v32/);
...
assert.match(app05, /const APP_VERSION='23'/);
assert.match(app05, /pier-beta\\\.n-e-alwaa\\\.workers\\\.dev/);
