...
assert.match(app, /const APP_SHELL_VERSION='54'/);
...
assert.match(sw, /pier-travel-expense-manager-v54/);
...
assert.match(app05, /const APP_VERSION='54'/);
...
assert.match(app06, /Calmer colours/);
