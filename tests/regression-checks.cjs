...
assert.match(app, /const APP_SHELL_VERSION='60'/);
...
assert.match(html, /PIER estimates mileage reimbursement at £0\.30 per claimable mile\./);
...
assert.match(sw, /pier-travel-expense-manager-v60/);
...
assert.match(app05, /const APP_VERSION='60'/);
...
assert.match(app00, /settings.mileageRate=APPROVED_MILEAGE_RATE/);
