...
assert.match(html, /miles claimed by all users in the last 12 months/);
...
assert.match(app05, /const APP_VERSION='19'/);
assert.match(sw, /pier-travel-expense-manager-v25/);
