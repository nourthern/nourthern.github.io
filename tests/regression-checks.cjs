...
assert.match(app, /const APP_SHELL_VERSION='35'/);
...
assert.match(app05, /const APP_VERSION='35'/);
assert.match(app05, /if\(APP_CHANNEL!=='beta'\)for\(const \[key,variables\] of Object\.entries\(colourMap\)\)/);
